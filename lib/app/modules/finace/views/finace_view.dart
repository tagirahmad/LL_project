              ...
              return Column(children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                              ...
                              content: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  TextField(
                                    ...
                                    onChanged: (text) =>
                                        OnTextChangedHelper.onChangedWifeIncome(
                                            text, controller),
                                  ),
                                  TextField(
                                    controller: FinanceController
                    ...
                    CardButton(
                      showSubtitle: () => SumHelper.showSumOfDream(controller),
                ...
                Row(
                  ...
                  children: <Widget>[
                    CardButton(
                      showSubtitle: () =>
                          SumHelper.showFundSumAccordingToIncome(controller),
                                  ...
                                  GetBuilder<FinanceController>(
                                    builder: (_) {
                                      return DropdownButton<String>(
                                        value: _showFundDropdownButtonValue(
                                            controller),
                                        iconEnabledColor: Colors.white,
                                        iconSize: 24,
                                        elevation: 16,
                                        dropdownColor: AppColors.LIGHT_PINK,
                              ...
                              content: Column(
                                ...
                                children: <Widget>[
                                  GetBuilder<FinanceController>(
                                    builder: (_) {
                                      return DropdownButton<String>(
                                        value: _showPocketDropdownButtonValue(
                                            controller),
                                        iconEnabledColor: Colors.white,
                                        iconSize: 24,
                                        elevation: 16,
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    CardButton(
                      showSubtitle: () => SumHelper.showExpensesSum(controller),
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    TextField(
                                      ...
                                      keyboardType: TextInputType.number,
                                      decoration: const InputDecoration(
                                        labelText: 'Оплата за квартиру/дом',
                                        hintText: 'руб. / мес',
                                        hintStyle:
                                            TextStyle(color: Colors.white),
                                        labelStyle:
                                    ...
                                    TextField(
                                      ...
                                      style:
                                          const TextStyle(color: Colors.white),
                                      decoration: const InputDecoration(
                                        labelText: 'Дополнительные платежи',
                                        hintText: 'руб. / мес',
                                        hintStyle:
                                            TextStyle(color: Colors.white),
                                        labelStyle:
                                    ...
                                    TextField(
                                      ...
                                      style:
                                          const TextStyle(color: Colors.white),
                                      decoration: const InputDecoration(
                                        labelText: 'Непредвиденные расходы',
                                        hintText: 'руб. / мес',
                                        hintStyle:
                                            TextStyle(color: Colors.white),
                                        labelStyle:
                    ...
                    itemBuilder: (context, index) {
                      return BankCard(
                        ...
                        paymentAmount: controller
                            .finance.value!.banks![index].monthlyPaymentAmount
                            .toStringAsFixed(1),
                        onTap: () {
                          showDialog<Widget>(
                            context: context,
                                    ...
                                    style: ButtonStyle(
                                        foregroundColor:
                                            MaterialStateProperty.all<Color>(
                                                Colors.red)),
                                    onPressed: () {
                                      controller.removeBankFromStore(index);
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      TextField(
                                        ...
                                        onChanged: (text) => OnTextChangedHelper
                                            .onChangedBankName(text, controller,
                                                index: index),
                                      ),
                                      TextField(
                                        controller: FinanceController
                            ...
                            (value) => ClearTextEditingControllers
                            ...
                            return FinancePopup(
                              ...
                              content: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    TextField(
                                      controller: FinanceController.to.bankName,
                                      keyboardType: TextInputType.text,
                                      style:
                                          const TextStyle(color: Colors.white),
                                      autofocus: true,
                                    ...
                                    TextField(
                                      ...
                                      style:
                                          const TextStyle(color: Colors.white),
                                      decoration: const InputDecoration(
                                        labelText: 'Общая сумма задолженности',
                                        hintText: 'руб',
                                        hintStyle:
                                            TextStyle(color: Colors.white),
                                        labelStyle:
                                    ...
                                    TextField(
                                      ...
                                      style:
                                          const TextStyle(color: Colors.white),
                                      decoration: const InputDecoration(
                                        labelText: 'Сумма ежемесячного платежа',
                                        hintText: 'руб',
                                        hintStyle:
                                            TextStyle(color: Colors.white),
                                        labelStyle:
                                ...
                                TextButton(
                                  onPressed: () {
                                    controller.saveBank(
                                      ...
                                      controller.plusToMonthlyPaymentAmount,
